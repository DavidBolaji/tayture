  ...
  return (
    <div className="flex items-center justify-center md:mx-20 mx-5 py-40 ">
      <div className="relative rounded-full  shadow-2xl ">
        ...
        <div className="cursor-pointer trans2 absolute w-3 rotate-[65deg] h-[124px] translate-x-16 -translate-y-[170px] shadow-2xl bg-[#fff]"></div>
        ...
        <div className="cursor-pointer trans2 bg-[#fff] absolute w-3 h-[122px] right-0 z-20 rotate-[120deg] -translate-x-16 -translate-y-[165px] shadow-2xl"></div>
        ...
        <div className="cursor-pointer trans2 absolute w-3 h-[125px] shadow-2xl bg-[#fff] -top-0 left-[48%]"></div>
